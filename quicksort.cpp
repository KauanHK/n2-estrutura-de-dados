...
void contagem(int *vet, int n){
    ...
    for (int i = 1; i <= 3; i++){
        for (int j = 0; j < 10; j++){
            ...
            // Calcular o tempo total de execucao
            t = clock() - t;

            tempos[j] = t;
            comparacoes[j] = quantComparacoes;
            trocas[j] = quantTrocas;

        }
        // Exibir tempo de execucao, numero de comparacoes e de trocas
        ...
        printf("\n");
        printf("Comparacoes: ");
        for (int comparacao : comparacoes){
            printf("%d, ", comparacao);
        }
        printf("\n");
        printf("Trocas: ");
